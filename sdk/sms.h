...
// прочитать сообщение по id. Ответ должен придти по ивенту EV_MSG_READ. part_num = 0 or 1.
...
// получить список id сообщений. msg_id_list - спиcок id сообщений, максимум 245.
...
//Удаление сообщения. Размер параметров верный!
...
//возможно что unk2=    UINT8	addr_type;	// 0 -SMS, 1 - EMAIL, 2 - No, 3 - Long Msg ??? 
//а чё такое unk1, хз. возможно 0 - телефон, 1 - сим
